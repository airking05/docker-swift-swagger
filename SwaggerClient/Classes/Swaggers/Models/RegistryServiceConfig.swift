...
public class RegistryServiceConfig: JSONEncodable {
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["AllowNondistributableArtifactsCIDRs"] = self.allowNondistributableArtifactsCIDRs?.encodeToJSON()
        nillableDictionary["AllowNondistributableArtifactsHostnames"] = self.allowNondistributableArtifactsHostnames?.encodeToJSON()
        nillableDictionary["InsecureRegistryCIDRs"] = self.insecureRegistryCIDRs?.encodeToJSON()
        nillableDictionary["IndexConfigs"] = self.indexConfigs?.encodeToJSON()
        nillableDictionary["Mirrors"] = self.mirrors?.encodeToJSON()
